...
export const NftPropertyDisplay = ({nft, properties, setProperties}) => {
    ...
    return(
      ...
      xs={12}
  >
    <Typography variant="p2" sx={{ alignSelf:"end", fontWeight:'bold',fontSize:{ xs: '12px', sm: '14px', md: '16px', lg: '16px', xl: '18px'}}}>Properties &emsp;</Typography>
          ...
          <Box sx={{width:650}}><TableContainer>
