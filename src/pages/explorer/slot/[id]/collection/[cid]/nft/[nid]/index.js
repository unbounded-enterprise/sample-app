...
import { NftDetailDisplay, NftPropertyDisplay } from 'src/components/NftDetailDisplay';
  ...
  return (
    <> 
      ...
      <Grid item xs={12} sx={{backgroundColor: "none"}}>
        <NextLink href={`/explorer/slot/${slotId}/collection/${collectionId}`} passHref><Button sx={slotButtonStyle}>Back</Button></NextLink> </Grid>
        </Grid>
